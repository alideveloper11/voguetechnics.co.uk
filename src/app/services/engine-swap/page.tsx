        ...
        <div className="container mx-auto px-4 lg:px-8 relative z-10">
          ...
          <div className="max-w-5xl mx-auto text-center">
            ...
            <div className="flex flex-col lg:flex-row gap-4 justify-center items-center mt-10">
              ...
              <Link
                href="/get-quote"
                className="bg-white text-slate-950 font-black px-6 py-3 rounded-2xl shadow-2xl hover:bg-slate-50 transition-all uppercase tracking-[0.2em] text-xs md:text-sm border-4 border-slate-950/10"
              >
                Get a Free Quote
              </Link>
              <a
                href="tel:01375531355"
                className="inline-flex items-center justify-center bg-white/15 text-white font-black px-6 py-3 rounded-2xl shadow-2xl hover:bg-white/20 transition-all uppercase tracking-[0.2em] text-xs md:text-sm border border-white/20"
              >
                Call Us Today
              </a>
            </div>
