...
export const metadata: Metadata = {
  ...
  description:
    "BMW 730d engine rebuild, repair, replacement and reconditioning across the UK. Vogue Technics in    N57 & B57 diesel specialists with transparent quotes and written warranty.",
  ...
  return (
    <BmwEngineModelPageClient
      ...
      sections={[
        ...
        },
        {
          ...
          paragraphs: [
            ...
            "Not within reach of our  workshop? That presents no barrier. We operate a fully managed engine collection and delivery service covering the entire United Kingdom. Send your unit to us and we will return it rebuilt, repaired, or replaced   fully tested and ready to install. For customers who need the engine installed locally, we work with a trusted network of approved fitting partners across the UK.",
      ...
      faqs={{
        ...
        items: [
          ...
          },
          {
            ...
            answer:
              "Yes. We offer complete supply and fit at our  workshop. For customers located elsewhere across the UK, we arrange fitting through our trusted network of approved installers.",
          },
          {
      ...
      finalCta={{
        ...
        paragraph:
          "Call Vogue Technics today or complete our online enquiry form for a fast, no-obligation quote. We are based in , and we serve BMW owners right across the United Kingdom. The 730d deserves engine work from people who genuinely understand it   and that is precisely what we provide.",
      }}
    />
  );
}
