  ...
  return (
    <div className={`w-full max-w-2xl bg-slate-900/80 backdrop-blur-md p-4 md:p-5 rounded-[2.5rem] border border-white/10 shadow-2xl relative ${className}`}>
      <form className="flex flex-col sm:flex-row gap-4">
        ...
        <button className="bg-primary hover:bg-emerald-600 text-white font-black py-2.5 px-5 rounded-2xl shadow-[0_10px_30px_rgba(25,135,84,0.3)] transition-all transform hover:-translate-y-1 flex items-center justify-center gap-1.5 whitespace-nowrap uppercase tracking-widest text-sm">
