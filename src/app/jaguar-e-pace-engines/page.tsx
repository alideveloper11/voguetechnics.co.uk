    ...
    <div className="bg-white min-h-screen">
      <section className="relative overflow-hidden bg-slate-900 pt-32 pb-24">
        <div className="absolute inset-0 z-0">
          <Image src="/images/car_bgg.jpg" alt="Jaguar E-Pace engine rebuild specialists in Grays" fill className="object-cover opacity-30 mix-blend-overlay" priority />
        ...
        <div className="container relative z-10 mx-auto px-4 lg:px-8">
          ...
          <div className="max-w-5xl pt-8">
            ...
            <motion.div initial={{ opacity: 0, y: 18 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.22 }} className="mt-7 max-w-4xl text-sm leading-relaxed text-slate-300 md:text-base space-y-4">
              ...
              <p>
                At Vogue Technics, based in Grays, Essex, we carry out Jaguar E-Pace engine rebuilds, targeted engine repairs, and complete reconditioned engine replacements across the full E-Pace range — backed by written warranty and supported by UK-wide collection and delivery.
              </p>
            </motion.div>
          </div>
        </div>
            ...
            <div className="rounded-[1.5rem] border border-slate-200 bg-slate-50 p-6">
              ...
              <ul className="mt-4 space-y-2 text-slate-700">
                {[
                  ...
                  "25+ years of specialist engine expertise from our Grays, Essex workshop.",
        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="rounded-[1.5rem] border border-slate-200 bg-slate-50 p-6">
              ...
              <p className="mt-3 text-slate-700 leading-relaxed">
                Supply-only delivery supported with technical guidance, or supply & fit at Grays.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="max-w-5xl mx-auto text-center space-y-6">
            ...
            <p className="text-emerald-50 leading-relaxed max-w-4xl mx-auto">
              Contact our Grays team for same‑day diagnostics, a reconditioned exchange unit, or a complete supply & fit service — with transparent pricing and warranty cover.
            </p>
