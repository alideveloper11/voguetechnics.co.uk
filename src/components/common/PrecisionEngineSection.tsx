        ...
        <div className="flex flex-col lg:flex-row items-start">
          ...
          <div className="w-full lg:w-[58%]">
            <p className="text-base font-bold text-slate-900 mb-0.5">
              Specialist Engine Rebuilds, Repairs &amp; Replacements
            </p>
            <p className="text-lg md:text-xl font-extrabold text-slate-900 mb-4">
              VOGUE TECHNICS.
            </p>
            ...
            {/* Tree section — 3-col grid: [left text | tree SVG | right text] */}
            <div
              className="grid"
              style={{
            ...
            >
              {/* Left text: steps 1 & 3 — starts at left edge, aligns with content above */}
              ...
              {/* Tree SVG — fill parent grid cell */}
          ...
          <div className="w-full lg:w-[42%] relative flex justify-end mt-12 lg:mt-0">

            {/* Top-right decorative forward-slashes */}
            <svg
            ...
            {/* Bottom-right decorative back-slashes */}
            <svg
