...
export const metadata: Metadata = {
  ...
  description:
    "BMW 320d engine rebuild, repair, replacement and reconditioning across the UK. Vogue Technics in    M47/N47/B47 diesel specialists with transparent quotes and written warranty.",
  ...
  return (
    <BmwEngineModelPageClient
      ...
      heroIntroParagraphs={[
        ...
        "At Vogue Technics, based in , we carry out specialist BMW 320d engine rebuild work for owners right across the United Kingdom. This is what we do, it's what we've always done, and it's what we do better than a general garage ever could.",
      ]}
      sections={[
        {
        ...
        {
          title: "Nationwide BMW 320d Service From Our Workshop in ",
          paragraphs: [
            "Our workshop is rooted in , but the service we provide reaches BMW 320d owners across the whole of the United Kingdom. We've built our infrastructure specifically so that geography is never a barrier to accessing specialist-quality engine work.",
            "Engine Collection & Delivery Across the UK",
            "We offer a fully managed engine collection and delivery service covering the whole of Great Britain. If your 320d can't make it to    or if the engine has already failed and the vehicle is off the road   we collect your old unit, carry out the rebuild or replacement at our workshop, and return the finished engine fully tested, correctly packaged, and ready to fit. We can also connect you with approved installation partners nationwide if local fitting is the more practical arrangement.",
      ...
      faqs={{
        ...
        items: [
          ...
          },
          {
            ...
            answer:
              "Both options are fully available. We carry out complete supply and fit at our  workshop. We also supply engines to customers working with their own installer, and we can connect you with approved fitting partners in your area if local installation is the more convenient arrangement for you.",
          },
          {
      ...
      finalCta={{
        ...
        paragraph:
          "Call Vogue Technics today or complete our online enquiry form for a fast, no-obligation quote. We're based in , and we serve BMW 320d owners right across the United Kingdom. Every generation of the 320d engine. Every failure pattern resolved correctly. Twenty-five years of proof.",
      }}
    />
  );
}
