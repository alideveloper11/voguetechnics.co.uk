...
export const metadata: Metadata = {
  ...
  description:
    "BMW 1 Series engine rebuild, repair, replacement and reconditioning across the UK. Specialist N47/B47 engine expertise from Vogue Technics in  with transparent quotes and written warranty.",
  alternates: {
