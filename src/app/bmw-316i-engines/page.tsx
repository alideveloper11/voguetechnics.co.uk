...
export const metadata: Metadata = {
  ...
  description:
    "BMW 316i engine rebuild, repair, replacement and reconditioning across the UK. Vogue Technics in Grays, Essex — N46/N43/N13 petrol specialists with transparent quotes and written warranty.",
  ...
  return (
    <BmwEngineModelPageClient
      ...
      sections={[
        {
          ...
          paragraphs: [
            ...
            "We know all three engines in genuine depth — not from a technical bulletin read once, but from years of rebuilding, repairing, and replacing them in our workshop in Grays. That knowledge makes a direct, practical difference to the quality and longevity of every repair we carry out.",
            "Over 25 Years of BMW Engine Work From Grays, Essex",
            "Our workshop has been handling BMW engine rebuilds, repairs, and replacements for more than a quarter of a century. The 316i has been part of our regular workload across every generation — E90 and F30 — and our experience with the petrol engine families fitted to this car is both broad and genuinely deep. Our reputation across Essex and beyond has been built entirely on results that hold up over time and advice that proves to be correct.",
        ...
        {
          title: "Nationwide BMW 316i Engine Service From Grays, Essex",
          paragraphs: [
            "Our workshop is based in Grays, Essex, but we serve BMW 316i owners across the whole of the United Kingdom. We've built a collection and delivery infrastructure specifically so that geography is never a reason to settle for a less qualified workshop.",
            "Engine Collection & Delivery Across the UK",
            "We offer a fully managed engine collection and delivery service covering the whole of Great Britain. If your 316i can't reach us in Grays — or if the engine has already failed and the vehicle is off the road — we collect your old unit, carry out the rebuild or replacement at our workshop, and return the finished engine fully tested, correctly packaged, and ready to fit. We can also connect you with approved installation partners nationwide if local fitting is the more practical option for your circumstances.",
      ...
      finalCta={{
        ...
        paragraph:
          "Call Vogue Technics today or complete our online enquiry form for a fast, no-obligation quote. We're based in Grays, Essex, and we serve BMW 316i owners right across the United Kingdom. The 316i deserves a specialist who genuinely knows these engines. That's exactly who we are.",
      }}
    />
  );
}
