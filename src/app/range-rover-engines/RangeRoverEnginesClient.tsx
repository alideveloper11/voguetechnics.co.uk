    ...
    <div className="bg-white min-h-screen">
          ...
          <div className="flex flex-col lg:flex-row gap-16 items-center">
            <div className="w-full lg:w-1/2 space-y-8">
              ...
              <div className="space-y-6 text-slate-600 text-lg leading-relaxed">
                <p>
                  With more than 20 years of dedicated experience, Vogue Technics has built a reputation as the UK’s leading specialist for Range Rover and Land Rover engine maintenance and rebuilds.
                </p>
                <p>
                  From the classic Vogue Mk3 to the high-performance SVR and the rugged Defender, we have the state-of-the-art facility and specialized tools to handle the most complex internal engine failures.
                </p>
      ...
      <section className="py-32 bg-white relative overflow-hidden px-4">
        <div className="container mx-auto lg:px-8">
          ...
          <div className="w-full h-1 bg-slate-100 mb-24 max-w-lg mx-auto rounded-full"></div>
        ...
        <div className="container mx-auto px-4 lg:px-8">
           <div className="flex flex-col lg:flex-row gap-24 items-center">
             ...
             <div className="w-full lg:w-1/2 space-y-12">
                <h2 className="text-4xl md:text-7xl font-black text-slate-900 tracking-tighter uppercase leading-none underline decoration-primary decoration-[12px] underline-offset-[16px]">Land Rover <span className="text-primary italic italic">Experts</span></h2>
