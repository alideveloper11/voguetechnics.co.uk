...
export const metadata: Metadata = {
  ...
  description:
    "BMW 330xd engine rebuild, repair, replacement and reconditioning across the UK. Vogue Technics in    xDrive diesel specialists with transparent quotes and written warranty.",
  ...
  return (
    <BmwEngineModelPageClient
      ...
      faqs={{
        ...
        items: [
          ...
          },
          {
            ...
            answer:
              "We do both. Full supply and fit is available at our  workshop. We can also arrange installation through our approved fitter network if you're based elsewhere in the UK.",
          },
          {
      ...
      finalCta={{
        ...
        paragraph:
          "Call Vogue Technics today or use our online enquiry form for a fast, honest, no-obligation quote. We're based in , and we work with BMW 330xd owners right across the United Kingdom. The 330xd is too good a car to trust to someone who doesn't fully understand it   and we do.",
      }}
    />
  );
}
