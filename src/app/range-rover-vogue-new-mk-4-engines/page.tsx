...
export const metadata: Metadata = {
  ...
  description:
    "Vogue Technics are Range Rover Vogue MK4 (L405) engine specialists in Grays, Essex. Expert rebuilds, repairs, replacements and supply & fit — transparent pricing and warranty-backed workmanship.",
