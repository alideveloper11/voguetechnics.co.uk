    ...
    <main className="bg-white min-h-screen">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                ...
                text: "Bring your vehicle to our Grays, Essex workshop or arrange UK-wide collection. We make accessing the right specialist as straightforward as possible.",
              },
              {
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                ...
                text: "Based in Grays, Essex, we offer UK-wide collection and delivery on all major engine work. Distance is not a reason to compromise on the quality of specialist you use.",
              },
            ].map((item, idx) => (
      ...
      <section className="py-24 bg-primary relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 lg:px-8 text-center relative z-10">
          ...
          <p className="text-emerald-100 text-sm md:text-base mb-14 max-w-3xl mx-auto font-medium leading-relaxed">
            Whatever your vehicle, whatever the fault — do not leave it to a garage that does not specialise in your platform, and do not accept a quote that was not based on a proper diagnostic. At Vogue Technics, we are based in Grays, Essex and offer UK-wide collection on all engine work.
          </p>
          ...
          <div className="mt-16 text-white/90 font-black uppercase tracking-widest text-[0.65rem]">
            Vogue Technics | Engine Specialists | Grays, Essex | UK-Wide Collection Available &nbsp; Range Rover • Land Rover • Jaguar • Audi • BMW
          </div>
        </div>
      </section>
      ...
      <FAQSection
        ...
        items={[
          ...
          {
            question: "Can you collect my vehicle if I am not near Grays, Essex?",
            answer:
