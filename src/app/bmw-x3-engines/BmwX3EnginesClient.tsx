...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Absolutely. We collect and return engines across the whole of the United Kingdom. Many of our BMW X3 customers are not local to Grays, and the process is managed smoothly from first contact through to delivery.",
  },
];
      ...
      <section className="relative min-h-[70vh] flex flex-col justify-center overflow-hidden bg-slate-900 pt-32 pb-20">
        ...
        <div className="container relative z-10 mx-auto px-4 lg:px-8">
          ...
          <div className="text-center max-w-5xl mx-auto">
            ...
            >
              At Vogue Technics, based in Grays, Essex, we carry out BMW X3 engine rebuilds, targeted repairs, and
            ...
            <motion.p
              ...
              className="text-base md:text-lg text-slate-200 leading-relaxed mb-10"
            >
              With over 25 years of BMW engine experience and a workshop in Grays that serves owners across the entire
              ...
              {[
                ...
                },
                {
                  ...
                  paragraphs: [
                    ...
                    "We source reconditioned BMW X3 engines from trusted UK suppliers across all engine families — N47, N57, B47, B57, N20, N55, and B48 — with verified mileage histories appropriate to the variant being replaced. Every unit undergoes thorough pre-installation testing at our Grays workshop before anything is fitted to your vehicle. Compression is checked across all cylinders, oil condition is assessed, and the overall integrity of the unit is verified before installation begins. On inline-six N57 and B57 units, we carry out additional assessments given the complexity and value of these engines.",
                    "We do not fit engines we have not verified. Our name goes on every job we complete, and that means every reconditioned unit we install has been assessed to a standard we are confident standing behind — not simply accepted from a supplier and bolted in.",
                  ],
                },
                {
      ...
      <section className="py-20 bg-slate-50 border-y border-slate-100">
        <div className="container mx-auto px-4 lg:px-8">
          <div className="max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8">
            {[
              {
                title: "UK-Wide BMW X3 Engine Service From Our Grays, Essex Workshop",
                paragraphs: [
              ...
              },
              {
                ...
                paragraphs: [
                  "Call Vogue Technics today or submit an online enquiry for a fast, honest, no-obligation quote. We are based in Grays, Essex, and we serve BMW X3 owners right across the United Kingdom. Whatever your engine, whatever the problem — trust the specialists who know the full X3 range inside and out.",
                ],
                cta: true,
              },
            ].map((block) => (
