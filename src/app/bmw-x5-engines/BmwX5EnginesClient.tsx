...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Yes. We collect and return engines across the whole of the United Kingdom. Many of our BMW X5 customers are not local to , and the process is managed smoothly from first contact through to delivery.",
  },
];
              ...
              {[
                {
                  ...
                  text: [
                    "M57, N57, N63, S63, N55, B57, B58 — every engine family, every failure pattern, across all five X5 generations.",
                  ],
                },
                {
                  title: "25 Years of BMW Engine Work From ",
                  text: [
                    "X5 owners come to us from across the UK — specialist knowledge of the full X5 engine range is harder to find than most owners realise.",
                  ],
                },
                {
                  title: "Clear, Itemised Quotes Before Any Work Begins",
                  text: [
                    "Clear, itemised quote before any work is authorised — no estimates that expand, no additions on collection day.",
                  ],
                },
              ].map((block) => (
      ...
      <section className="py-16 md:py-20 bg-slate-50">
        <div className="container mx-auto px-4 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-12">
            <h2 className="text-2xl md:text-3xl font-bold text-slate-900">Our BMW X5 Engine Services</h2>
            <div className="w-24 h-1 bg-primary mx-auto rounded-full mt-4"></div>
            <p className="mt-6 text-slate-600 text-[1.05rem] leading-relaxed">
              We offer a full spectrum of engine services tailored specifically to BMW X5 vehicles. Whatever your engine problem, we have the tools, parts, and expertise to solve it properly.
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
            {[
              { title: "Head Gasket Replacement", body: "OEM-grade head gasket repair for M57, N57, N55, and S63 units — full cylinder head inspection and pressure testing included.", href: "/services/head-gasket-replacement" },
              { title: "Timing Chain Replacement", body: "Full timing chain kit for N57D30, M57, and N47 units — chain, tensioners, guides, and sprockets replaced together.", href: "/services/timing-chain-replacement" },
              { title: "Timing Belt Replacement", body: "Manufacturer-approved belts and tensioners for applicable X5 variants — water pump replacement recommended at the same time.", href: "/services/timing-belt-replacement" },
              { title: "Turbo Replacement", body: "Quality replacement turbos for all X5 diesel and petrol variants — post-installation boost pressure and oil feed testing included.", href: "/services/turbo-replacement" },
              { title: "Engine Rebuild", body: "Full strip-down and precision rebuild for N57, S63B44, M57, N55, and B58 units — up to 40% less than a new engine.", href: "/services/engine-rebuild" },
              ...
              { title: "Engine Swap", body: "Performance upgrades and full engine swaps across all X5 variants — including ECU reconfiguration and xDrive integration where required.", href: "/services/engine-swap" },
      ...
      <section className="py-20 bg-slate-50 border-y border-slate-100">
        <div className="container mx-auto px-4 lg:px-8">
          <div className="max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8">
            {[
              {
                title: "UK-Wide Engine Service From Our Workshop",
                paragraphs: [
                  ...
                  "Most X5 engine rebuilds are completed within 5–10 working days. Every job carries a written warranty.",
                ],
              },
              {
                title: "Ready to get your BMW X5 back on the road?",
                paragraphs: [
                  "Contact Vogue Technics for a fast, no-obligation quote. We serve BMW X5 owners right across the United Kingdom.",
                ],
                cta: true,
              },
            ].map((block) => (
