...
export const metadata: Metadata = {
  ...
  description:
    "BMW 525d engine rebuild, repair, replacement and reconditioning across the UK. Vogue Technics in    specialist BMW engine work with transparent quotes and written warranty.",
...
export default function Bmw525dEnginesPage() {
  return (
    <BmwEngineModelPageClient
      ...
      heroIntroParagraphs={[
        "If your BMW 525d has started letting you down   whether it's losing power, burning oil, overheating, or worse   you're in the right place. At Vogue Technics, based in , we specialise in BMW engine work with over 25 years of hands-on experience. From a full BMW 525d engine rebuild to timing chain repairs, turbo replacements, and head gasket work, we handle it all under one roof   with the expertise, tooling, and genuine parts knowledge that most general garages simply don't have.",
      ...
      sections={[
        {
          ...
          paragraphs: [
            ...
            "Over 25 Years of Engine Expertise in ",
            "Since day one, Vogue Technics has built its reputation on doing engine work properly. No shortcuts. No temporary fixes. Our workshop in  serves customers across  and the wider UK, and a significant portion of our work comes through referrals   because when we rebuild or repair an engine, it stays sorted.",
      ...
      faqs={{
        ...
        items: [
          ...
          },
          {
            ...
            answer:
              "Both. We offer full supply and fit at our  workshop. If you're located elsewhere in the UK, we can arrange fitting through our approved installer network.",
          },
          {
      ...
      finalCta={{
        ...
        paragraph:
          "Call Vogue Technics today or fill in our online enquiry form for a fast, no-obligation quote. We're based in , and serve BMW owners across the whole of the United Kingdom. Don't trust your 525d to a general garage   trust the specialists who know it best.",
      }}
    />
  );
}
