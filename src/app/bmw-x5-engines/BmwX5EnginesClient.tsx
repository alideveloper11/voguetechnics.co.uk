      ...
      <section className="relative min-h-[70vh] flex flex-col justify-center overflow-hidden bg-slate-900 pt-32 pb-20">
        ...
        <div className="container relative z-10 mx-auto px-4 lg:px-8">
          ...
          <div className="text-center max-w-5xl mx-auto">
            ...
            >
              At Vogue Technics, based in , we carry out BMW X5 engine rebuilds, targeted repairs, and
              ...
              {[
                ...
                },
                {
                  ...
                  paragraphs: [
                    ...
                    "We source reconditioned BMW X5 engines from trusted UK suppliers across all engine families   M57, N57, B57, N55, B58, S63, and N47   with verified mileage and service histories appropriate to the specific engine code and application. An S63B44 reconditioned unit requires different sourcing criteria than an N57D30 diesel unit, and we apply those criteria rather than accepting whatever is available at the lowest price point. Every unit undergoes thorough pre-installation testing at our  workshop   compression across all cylinders, oil condition analysis, and a full integrity assessment before installation is confirmed. We verify what we install. Our name goes on the work, and that means every reconditioned unit we fit has been assessed to a standard we are confident standing behind.",
                  ],
                },
                {
                  title: "Engine Swap",
          ...
          <div className="max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8">
            {[
              ...
              },
              {
                ...
                paragraphs: [
                  "Call Vogue Technics today or submit an online enquiry for a fast, honest, no-obligation quote. We are based in , and we serve BMW X5 owners right across the United Kingdom. Whatever chassis, whatever engine, whatever the problem   trust the specialists who know the full X5 range inside and out.",
                ],
                cta: true,
              },
            ].map((block) => (
