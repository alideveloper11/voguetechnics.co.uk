...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Both options are available. We carry out full supply and fit at our Grays, Essex workshop. We also supply engines to customers working with their own installer, and we can connect you with approved fitting partners in your area if local installation is the more practical option for you.",
  },
  {
        ...
        <div className="container relative z-10 mx-auto px-4 lg:px-8">
          ...
          <div className="text-center max-w-5xl mx-auto">
            ...
            >
              ...
              serious problem, the experience shifts quickly. A rattling N47 timing chain on a cold Essex morning, a turbo that&apos;s gradually losing
            ...
            >
              At Vogue Technics, based in Grays, Essex, we carry out specialist BMW 3 Series engine rebuild work for owners right across the United
            ...
            <div className="mt-10 grid grid-cols-1 md:grid-cols-3 gap-6">
              {[
                ...
                },
                {
                  ...
                  text: "Our workshop in Grays, Essex has been carrying out BMW 3 Series engine rebuilds, repairs, and replacements since the E46 was the current model. That's a span of experience that covers every significant generation of the 3 Series — E46, E90, F30, and G20 — and every major powertrain variant sold in the UK market. Our reputation has never been built on advertising spend. It's been built on results that hold up, prices that are honest, and a team that communicates clearly throughout every job.",
                },
                {
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-4 lg:px-8">
          <div className="max-w-5xl mx-auto rounded-[2.25rem] border border-slate-200 bg-gradient-to-b from-white to-slate-50 p-8 md:p-12 shadow-sm">
            <h2 className="text-2xl md:text-4xl font-extrabold text-slate-900 tracking-tight">
              Nationwide BMW 3 Series Engine Service From Grays, Essex
            </h2>
            <p className="mt-5 text-slate-700 leading-relaxed">
              Our workshop is based in Grays, Essex, but the service we provide reaches BMW 3 Series owners right across the United Kingdom. Distance
            ...
            <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="rounded-[1.75rem] border border-slate-200 bg-white p-7">
                ...
                <p className="mt-3 text-slate-700 leading-relaxed">
                  ...
                  it to Grays — or if the engine has already failed and the car isn&apos;t driveable — we collect your old unit, carry out the rebuild or
      ...
      <section className="py-20 bg-primary relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 lg:px-8 text-center max-w-4xl space-y-8 relative z-10">
          ...
          <p className="text-emerald-100 text-base md:text-lg font-medium max-w-3xl mx-auto leading-relaxed">
            ...
            Technics today or complete our online enquiry form for a fast, no-obligation quote. We&apos;re based in Grays, Essex, and we serve BMW 3
