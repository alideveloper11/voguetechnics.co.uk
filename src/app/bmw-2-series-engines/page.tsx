...
export const metadata: Metadata = {
  ...
  description:
    "BMW 2 Series engine rebuild, repair, replacement and reconditioning across the UK. Vogue Technics in Grays, Essex — transparent quotes, written warranty, and specialist BMW engine expertise.",
  alternates: {
