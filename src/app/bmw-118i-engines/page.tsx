...
export const metadata: Metadata = {
  title: "BMW 118i Engine Rebuild — Petrol Engine Specialists Based in Grays, Serving the Whole of the UK",
  description:
    "BMW 118i engine rebuild, repair and replacement in Grays with UK-wide support. Vogue Technics — petrol engine specialists for N13/B38 platforms with transparent quotes and written warranty.",
...
export default function Bmw118iEnginesPage() {
  return (
    <BmwEngineModelPageClient
      ...
      h1Rest="— Petrol Engine Specialists Based in Grays, Serving the Whole of the UK"
      heroIntroParagraphs={[
      ...
      finalCta={{
        ...
        paragraph:
          "Call Vogue Technics today or complete our online enquiry form for a fast, no-obligation quote. We're based in Grays and proudly serve BMW owners right across the United Kingdom. Your 118i deserves more than a guess — trust the specialists who know exactly what they're doing.",
      }}
    />
  );
}
