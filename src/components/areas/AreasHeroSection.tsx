...
type AreasHeroSectionProps = {
  title: string;
  subtitle: string;
};

export default function AreasHeroSection({ title, subtitle }: AreasHeroSectionProps) {
  return (
    <section className="relative overflow-hidden bg-white pt-28 pb-20">
      ...
      <div className="container relative z-10 mx-auto px-4 lg:px-8">
        <Breadcrumbs items={[{ name: "Areas Covered", href: "/areas" }]} />
