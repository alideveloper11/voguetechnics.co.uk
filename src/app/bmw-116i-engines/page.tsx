...
export const metadata: Metadata = {
  title: "BMW 116i Engine Rebuild — Expert Repairs, Rebuilds & Replacements in Grays, UK",
  description:
    "BMW 116i engine rebuild, repair and replacement in Grays with UK-wide support. Vogue Technics — BMW engine specialists with transparent quotes and written warranty.",
...
export default function Bmw116iEnginesPage() {
  return (
    <BmwEngineModelPageClient
      ...
      h1Rest="— Expert Repairs, Rebuilds & Replacements in Grays, UK"
      heroIntroParagraphs={[
        "If your BMW 116i is losing power, burning oil, or has completely given up — you're in the right place. At Vogue Technics, based in Grays, we specialise in BMW engine work, and the 116i is one we know inside out. Whether you need a full BMW 116i engine rebuild, a reconditioned unit, or a targeted repair, our technicians deliver results that last — backed by over 25 years of hands-on experience serving drivers across the UK.",
      ...
      finalCta={{
        ...
        paragraph:
          "Call Vogue Technics today or complete our online enquiry form for a fast, no-obligation quote. We're based in Grays and proudly serve BMW owners across the whole of the United Kingdom. Don't trust your 116i to just anyone — trust the specialists who know it properly.",
      }}
    />
  );
}
