...
export const metadata: Metadata = {
  ...
  description:
    "BMW 518d engine rebuild, repair, replacement and reconditioning across the UK. Vogue Technics in    specialist BMW diesel engine work with transparent quotes and written warranty.",
  ...
  return (
    <BmwEngineModelPageClient
      ...
      heroIntroParagraphs={[
        ...
        "At Vogue Technics, based in , we understand the 518d's specific challenges in a way that comes from 25 years of working on BMW diesel engines across every generation. Whether you need a full BMW 518d engine rebuild, a quality reconditioned replacement, or targeted repair work, you've found the specialist who genuinely knows this engine.",
      ]}
      sections={[
        {
          ...
          paragraphs: [
            ...
            "25 Years of BMW Diesel Engine Expertise, Based in ",
      ...
      finalCta={{
        ...
        paragraph:
          "Call Vogue Technics today or use our online enquiry form for a fast, honest, no-obligation quote. We're based in , and we work with BMW 518d owners right across the United Kingdom. This is a car worth looking after properly   and we're the team who knows exactly how to do it.",
      }}
    />
  );
}
