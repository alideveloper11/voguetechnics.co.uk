...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Our complete supply and fit service is based at our Grays workshop in Essex. For customers further afield, we offer UK‑wide delivery with full technical support. Emergency fitting slots and same‑day diagnostics are available for urgent cases.",
  },
  {
    ...
    <div className="bg-white min-h-screen">
      <section className="relative overflow-hidden bg-slate-900 pt-32 pb-24">
        <div className="absolute inset-0 z-0">
          <Image src="/images/car_bgg.jpg" alt="Jaguar XK8 engine specialists in Grays" fill className="object-cover opacity-30 mix-blend-overlay" priority />
        ...
        <div className="container relative z-10 mx-auto px-4 lg:px-8">
          ...
          <div className="max-w-5xl pt-8">
            ...
            <motion.div initial={{ opacity: 0, y: 18 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.22 }} className="mt-7 max-w-4xl text-sm leading-relaxed text-slate-300 md:text-base space-y-4">
              ...
              <p>
                At Vogue Technics in Grays, UK, we supply, rebuild, and fit Jaguar XK8 engines across all production years and variants — from 1997 through to 2006 — covering both coupe and convertible models with honest assessments, quality rebuilds, and a transparent service from our dedicated workshop.
              </p>
            </motion.div>
          </div>
        </div>
          ...
          <div className="max-w-5xl mx-auto space-y-10">
            <div className="rounded-[1.5rem] border border-slate-200 bg-slate-50 p-6">
              ...
              <p className="mt-4 text-slate-700 leading-relaxed">
                We stock and supply Jaguar XK8 engines across both the 4.0 and 4.2 litre AJ‑V8 variants. Every unit — reconditioned, remanufactured, or used — is fully tested, properly documented, and dispatched with warranty cover from our Grays workshop.
              </p>
            </div>
            ...
            <div className="rounded-[1.5rem] border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <p className="mt-3 text-slate-700 leading-relaxed">
                Whether you need a complete supply and fit at our Grays workshop or a rebuilt XK8 engine delivered to your door or chosen garage — we accommodate both. Every supply-only order includes full technical support throughout the fitting process.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="max-w-5xl mx-auto text-center space-y-6">
            ...
            <p className="text-emerald-50 leading-relaxed max-w-4xl mx-auto">
              Contact our specialists in Grays today. Whether you need same-day diagnostics, a Nikasil repair, a fully reconditioned 4.0 or 4.2 litre V8, or an emergency fitting slot — we&apos;re here with straight answers and genuine specialist knowledge.
            </p>
