...
export const metadata: Metadata = {
  ...
  description:
    "BMW 330d engine rebuild, repair, replacement and reconditioning across the UK. Vogue Technics in Grays, Essex — specialist BMW engine work with transparent quotes and written warranty.",
...
export default function Bmw330dEnginesPage() {
  return (
    <BmwEngineModelPageClient
      ...
      heroIntroParagraphs={[
        "If your BMW 330d has started letting you down — whether it's losing power, smoking under load, or simply refusing to start — you're in the right hands. At Vogue Technics, based in Grays, Essex, we specialise in precision BMW engine work, and the 330d is one we know inside out. From a full BMW 330d engine rebuild to timing chain repairs, turbo replacements, and head gasket work, we deliver the kind of quality that keeps your car on the road for years to come — backed by over 25 years of hands-on experience.",
      ]}
      sections={[
        {
          ...
          paragraphs: [
            ...
            "Over 25 Years of Engine Expertise, Based in Grays, Essex",
        ...
        },
        {
          ...
          paragraphs: [
            ...
            "Based in Grays but serving the whole country. If travelling to Essex isn't practical, we offer a straightforward engine collection and delivery service. Send us your unit and we'll return it fully rebuilt, tested, and ready to fit — or we can connect you with our network of trusted approved fitters nationwide.",
      ...
      faqs={{
        ...
        items: [
          ...
          },
          {
            ...
            answer:
              "Yes. We offer full supply and fit at our Grays, Essex workshop, and can also arrange installation through our approved fitter network if you're based elsewhere in the UK.",
          },
        ],
      }}
      finalCta={{
        ...
        paragraph:
          "Call Vogue Technics today or submit your details through our online enquiry form for a fast, honest, no-obligation quote. We're based in Grays, Essex, and work with BMW 330d owners right across the United Kingdom. Don't settle for a general garage — trust the specialists who know your engine.",
      }}
    />
  );
}
