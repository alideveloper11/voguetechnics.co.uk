...
export const metadata: Metadata = {
  title: "BMW 120d Engine Rebuild — Diesel Engine Specialists in Grays, Serving BMW Owners Across the UK",
  description:
    "BMW 120d engine rebuild, repair and replacement in Grays with UK-wide support. Vogue Technics — diesel specialists for N47/B47 platforms with transparent quotes and written warranty.",
...
export default function Bmw120dEnginesPage() {
  return (
    <BmwEngineModelPageClient
      ...
      h1Rest="— Diesel Engine Specialists in Grays, Serving BMW Owners Across the UK"
      heroIntroParagraphs={[
      ...
      finalCta={{
        ...
        paragraph:
          "Call Vogue Technics today or complete our online enquiry form for a fast, no-obligation quote. We're based in Grays and serve BMW owners right across the United Kingdom. The 120d is a serious diesel — it deserves a specialist who treats it that way.",
      }}
    />
  );
}
