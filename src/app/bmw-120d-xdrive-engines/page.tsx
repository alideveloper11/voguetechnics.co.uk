...
export const metadata: Metadata = {
  title: "BMW 120d xDrive Engine Rebuild   All-Wheel-Drive Diesel Specialists in , Serving the Whole of the UK",
  description:
    "BMW 120d xDrive engine rebuild, repair and replacement in  with UK-wide support. Vogue Technics   xDrive diesel specialists with transparent quotes and written warranty.",
...
export default function Bmw120dXdriveEnginesPage() {
  return (
    <BmwEngineModelPageClient
      ...
      h1Rest="  All-Wheel-Drive Diesel Specialists in , Serving the Whole of the UK"
      heroIntroParagraphs={[
      ...
      sections={[
        {
          ...
          paragraphs: [
            ...
            "Over 25 years, our reputation in  and across the UK has been built entirely on the quality of the work we return. When your 120d xDrive leaves our workshop, it leaves properly fixed.",
      ...
      finalCta={{
        ...
        paragraph:
          "Call Vogue Technics today or complete our online enquiry form for a fast, no-obligation quote. We're based in  and serve BMW owners right across the United Kingdom. The xDrive system deserves a workshop that genuinely understands it   and that's exactly what we are.",
      }}
    />
  );
}
