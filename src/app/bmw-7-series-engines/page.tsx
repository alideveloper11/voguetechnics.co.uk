...
export const metadata: Metadata = {
  ...
  description:
    "BMW 7 Series engine rebuild, repair, replacement and reconditioning across the UK. Vogue Technics in Grays, Essex — specialist BMW flagship engine work with transparent quotes and written warranty.",
