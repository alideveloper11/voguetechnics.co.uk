...
export const metadata: Metadata = pageMetadata.jaguarXk;

const engineCodes = getEngineCodesEntry("jaguar-xk-engines");
        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="rounded-[1.5rem] border border-slate-200 bg-slate-50 p-6">
              ...
              <p className="mt-3 text-slate-700 leading-relaxed">Sameâ€‘day diagnostics in  to confirm the exact fault and best route.</p>
            </div>
            <div className="rounded-[1.5rem] border border-slate-200 bg-slate-50 p-6">
