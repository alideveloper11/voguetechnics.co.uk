...
const heroParagraphs = [
  ...
  "At Vogue Technics, based in Grays, Essex, BMW 7 Series engine rebuilds, repairs, and replacements are work we approach with the depth of expertise that BMW's flagship demands. The N63 twin-turbo V8's thermal management challenges, the N57 diesel's timing chain vulnerabilities, the B58 straight-six's oil system sensitivities, the earlier M62 and N62 naturally aspirated V8 units — we understand these engines in practical, hands-on terms developed over more than 25 years of dedicated BMW engine work. If your 7 Series is experiencing engine trouble, you have found the right workshop.",
];
...
const whyChooseBlocks = [
  ...
  },
  {
    ...
    text: [
      ...
      "Our customer base across Essex, London, and the wider UK is built almost entirely on referrals from owners who experienced our work directly and recommended us without hesitation. When we work on your 7 Series engine, the result reflects twenty-five years of accumulated knowledge applied specifically to your vehicle and its engine family.",
    ],
  },
  {
    ...
    paragraphs: [
      {
        ...
        text: [
          "Not within practical reach of our Grays workshop? That presents no obstacle whatsoever. We operate a fully managed engine collection and delivery service covering the entire United Kingdom. Send your unit to us and we will return it rebuilt, repaired, or replaced — fully tested, correctly configured, and ready to install. For customers who need the finished engine installed locally, we work with a trusted network of approved fitting partners across the UK whose standard of work we are confident in.",
        ],
      },
      {
...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Both options are available. We offer complete supply and fit at our Grays, Essex workshop. For customers located across the rest of the UK, we arrange fitting through our trusted approved installer network.",
  },
  {
      ...
      <section className="py-20 bg-primary relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 lg:px-8 text-center max-w-4xl space-y-8 relative z-10">
          ...
          <p className="text-emerald-100 text-base md:text-lg font-medium max-w-3xl mx-auto leading-relaxed">
            Call Vogue Technics today or complete our online enquiry form for a fast, no-obligation quote. We are based in Grays,
            Essex, and we serve BMW owners right across the United Kingdom. The 7 Series is BMW&apos;s flagship — and it deserves the
