...
export const services: Service[] = [
  ...
  },
  {
    ...
    detailedParagraphs: [
      "Sometimes, an engine failure is so severe or common that repairing it simply isn't the best financial or mechanical decision. This is where professional engine replacement comes . Whether your original unit has suffered a catastrophic failure or has reached extremely high mileage, a replacement engine can give your vehicle a brand-new lease on life for a fraction of the cost of a new car.",
  ...
  },
  {
    ...
    preFaqParagraphs: [
      ...
      "For a truly convenient experience, choose the UK's leading engine specialists. We offer a full logistics solution, including nationwide vehicle recovery directly to our  workshop. From the moment we take your keys to the final multi-point test drive, we handle every technical and administrative detail, allowing you to focus on the joy of getting your upgraded or restored vehicle back on the road.",
    ],
    faqs: [
      {
  ...
  },
  {
    ...
    preFaqParagraphs: [
      ...
      "Reliability is our hallmark. We understand that your cambelt is the only thing standing between your engine and a total top-end rebuild. That's why we don't just 'fit a belt'; we perform a complete audit of the timing system, ensuring that the new components are torqued and timed to literal micrometer precision. This specialized level of care is why we are the preferred choice for premium car owners across  and West Thurrock.",
