...
function buildAudiEngineSizeContent(spec: EngineSizeSpec): ModelPageContent {
  const metaTitle = `${spec.display} — Rebuild, Repair & Replacement | Vogue Technics (Grays, Essex)`;
  const metaDescription =
    `${spec.display} specialists in Grays, Essex. Expert diagnostics, rebuilds, repairs and replacement engines for ${spec.exampleEngines}. UK-wide collection/delivery and written warranty available.`;

  return {
    metaTitle,
    metaDescription,
    h1: `${spec.display} — Engine Rebuild, Repair & Replacement Specialists in Grays, Essex`,
    intro: [
      ...
      `At Vogue Technics in Grays, Essex, we provide specialist engine rebuild, repair and replacement services for ${spec.display.toLowerCase()} across the UK. We work on ${spec.exampleEngines} configurations commonly found in ${spec.typicalApplications}, with clear, itemised quotes and written warranty on major work.`,
    ],
    sections: [
      {
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "We offer supply-and-fit at our Grays workshop, plus UK-wide collection and return. Typical turnaround for many repairs is 3–7 working days; full rebuilds usually take 5–10 working days depending on parts and internal condition.",
        ],
      },
    ],
    faqs: [
      ...
      },
      {
        ...
        answer:
          "Yes. If you’re not local to Essex, we can arrange collection/return and support fitting through approved installers where appropriate.",
      },
      {
...
const audiModelContent: Record<string, ModelPageContent> = {
  ...
  "audi-a1-engines": {
    ...
    metaDescription:
      "Audi A1 engine rebuild, repair and replacement specialists in Grays, Essex. Vogue Technics provide diagnostics, timing chain/belt work, turbo replacement and warranty-backed engine services UK-wide.",
    h1: "Audi A1 Engine Rebuild — Expert Engine Services Across the UK",
    intro: [
      "If your Audi A1 has started burning oil, losing power, or throwing up warning lights you can't ignore, you're in the right place. At Vogue Technics, based in Grays, Essex, we specialise in precision engine work for Audi vehicles — and the A1 is one we know inside out.",
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          "We've been rebuilding engines since before most online \"specialists\" existed. Our reputation across Grays and the wider UK has been earned through consistent, quality-first work — not marketing promises. When we hand your Audi A1 back to you, it's built to last.",
        ],
      },
      {
      ...
      },
      {
        ...
        paragraphs: [
          "Can't get to our workshop in Grays, Essex? No problem. We offer a fully managed engine collection and delivery service across the whole of the UK. Ship your unit to us and we'll return it fully rebuilt, tested, and ready to fit — or arrange installation through our approved fitter network near you.",
        ],
      },
      {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "Yes. We’re based in Grays, Essex, but serve Audi owners UK-wide through collection and delivery and installer support.",
      },
    ],
  },
  "audi-a1-sportback-engines": {
    ...
    metaDescription:
      "Audi A1 Sportback engine rebuild, repair and replacement specialists in Grays, Essex. Timing chain/belt, turbo and warranty-backed engine services with UK-wide collection and delivery.",
    ...
    intro: [
      ...
      "At Vogue Technics, based in Grays, Essex, we live and breathe Audi engines. The A1 Sportback, across every generation and engine variant, is a vehicle we know thoroughly — from the peppy 1.0 TFSI three-cylinder through to the 1.4 TFSI and the 1.6 TDI.",
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          "Our customer base across Grays and the wider UK has grown almost entirely through word of mouth. When an Audi A1 Sportback leaves our workshop, the owner goes away satisfied — and tells other Audi drivers about us.",
      ...
      },
      {
        ...
        paragraphs: [
          "Not local to Grays, Essex? That's no obstacle. We offer a fully managed engine collection and delivery service covering the entire United Kingdom.",
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "Yes. We're based in Grays, Essex, but we serve Audi A1 Sportback owners across the entire United Kingdom through our collection and delivery service and our approved installer network.",
      },
    ],
  },
  "audi-a2-engines": {
    ...
    metaDescription:
      "Audi A2 engine rebuild, repair and replacement specialists in Grays, Essex. Accurate diagnostics, timing/cooling repairs, rebuilds and verified replacements with UK-wide collection and written warranty.",
    ...
    intro: [
      ...
      "At Vogue Technics in Grays, Essex, we provide specialist engine rebuild, repair and replacement services for Audi A2 owners across the UK. Whether you need targeted engine repair, timing-related work, or a full rebuild, we diagnose accurately and deliver work that lasts — backed by written warranty.",
    ],
    sections: [
      {
      ...
      },
      {
        ...
        paragraphs: [
          "Not local to Essex? We offer UK-wide collection and return and can help with fitting support where needed. We confirm realistic turnaround times at booking and keep you updated throughout the job.",
        ],
      },
      {
        title: "Ready to get your Audi A2 engine sorted properly?",
        paragraphs: [
          "Call Vogue Technics today or use our online enquiry form for a fast, no-obligation quote. We’re based in Grays, Essex and serve Audi A2 owners across the whole of the UK with precise diagnostics, honest pricing and engine work built to last.",
        ],
      },
    ],
    faqs: [
  ...
  "audi-a3-engines": {
    ...
    metaDescription:
      "Audi A3 engine rebuild, repair and replacement specialists in Grays, Essex. Timing chain/belt, turbo and warranty-backed services for all A3 variants with UK-wide collection and delivery.",
    ...
    intro: [
      ...
      "At Vogue Technics, based in Grays, Essex, we specialise in Audi and Volkswagen Group engines. The A3, across every body style and generation — Sportback, Saloon, Convertible, and Limousine — is a vehicle we work on every single week.",
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          "Since we opened our doors in Grays, our customer base has grown almost entirely through recommendation. Audi A3 owners across London, Essex, and the wider UK find us because another Audi driver sent them our way.",
      ...
      },
      {
        ...
        paragraphs: [
          "We cover the complete range of Audi A3 engine services at our Grays workshop. Whether your A3 needs a focused repair or a ground-up engine rebuild, we have the expertise, equipment, and genuine parts knowledge to do it properly.",
        ],
      },
      {
      ...
      },
      {
        ...
        paragraphs: [
          "Not within reach of Grays, Essex? No problem at all. We operate a fully managed engine collection and delivery service covering the entire UK.",
    ...
    faqs: [
      ...
      },
      {
        question: "Do you cover the whole of the UK?",
        answer:
          "Yes. We're based in Grays, Essex, but we serve Audi A3 owners across the entire United Kingdom through our collection and delivery service and our nationwide approved installer network.",
      },
    ],
  },
  "audi-a4-engines": {
    ...
    metaDescription:
      "Audi A4 engine rebuild, repair and replacement specialists in Grays, Essex. Timing chain/belt, turbo and warranty-backed services for Saloon, Avant, Allroad and Cabriolet with UK-wide support.",
    ...
    intro: [
      ...
      "At Vogue Technics, based in Grays, Essex, we work on Audi and Volkswagen Group engines every single day. The A4, across every generation and body style — Saloon, Avant, Allroad, and Cabriolet — is a vehicle we understand at a level most workshops simply don't reach.",
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          "Vogue Technics has been rebuilding, repairing, and replacing Audi engines since before the B7 A4 even existed. Our reputation across Grays, Essex, and the wider UK has grown steadily through word of mouth.",
        ],
      },
      {
      ...
      },
      {
        ...
        paragraphs: [
          "We offer a complete range of Audi A4 engine services at our Grays workshop, covering everything from targeted single-component repairs through to full ground-up engine rebuilds.",
        ],
      },
      {
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Audi A4 Engine Replacement — We supply and fit quality used and reconditioned Audi A4 engines sourced from verified UK suppliers. Every unit is inspected and tested before installation — we never fit an engine without knowing what condition it's in.",
          "Audi A4 Engine Swap & Conversion — Mountings, ancillaries, ECU remapping, and full post-swap diagnostics are handled in-house at our Grays workshop.",
        ],
      },
      {
    ...
    faqs: [
      ...
      },
      {
        question: "Do you cover the whole of the UK?",
        answer:
          "Absolutely. We're based in Grays, Essex, but we serve Audi A4 owners right across the United Kingdom through our engine collection and delivery service and our nationwide network of approved fitting partners.",
      },
    ],
  },
  "audi-a4-allroad-engines": {
    metaTitle: "Audi A4 Allroad Engine Repairs, Rebuilds & Replacements — Expert Service in Grays, Essex",
    metaDescription:
      "Audi A4 Allroad engine specialists in Grays, Essex. Diagnostics, repairs, rebuilds and replacements for 2.0 TFSI and 2.0 TDI variants with UK-wide support and written warranty.",
    h1: "Audi A4 Allroad Engine Repairs, Rebuilds & Replacements — Expert Service in Grays, Essex",
    intro: [
    ...
    sections: [
      {
        ...
        paragraphs: [
          ...
          "We never recommend work without understanding the problem first. Every Audi A4 Allroad that comes through our doors in Grays gets a thorough diagnostic assessment before we quote or touch anything.",
      ...
      {
        title: "Fast UK-Wide Service & Engine Delivery From Grays, Essex",
        paragraphs: [
  ...
  "audi-a5-engines": {
    metaTitle: "Audi A5 Engine Rebuild, Repair & Replacement — Trusted Specialists in Grays, Essex",
    metaDescription:
      "Audi A5 engine rebuild, repair and replacement specialists in Grays, Essex. Timing chain/belt, turbo and warranty-backed services for Coupe, Sportback and Cabriolet variants with UK-wide support.",
    h1: "Audi A5 Engine Rebuild, Repair & Replacement — Trusted Specialists in Grays, Essex",
    intro: [
      ...
      "At Vogue Technics, based in Grays, Essex, we specialise in premium engine work across all Audi A5 variants and generations. From the B8's well-documented TFSI issues to the 3.0 TDI timing chain problems on higher-mileage examples, we've worked through every known fault pattern this engine family produces.",
    ],
    sections: [
      {
        ...
        paragraphs: [
          ...
          "We never quote blind. Every Audi A5 that arrives at our Grays workshop receives a thorough diagnostic assessment before we recommend a single penny of work. Compression testing, oil analysis, fault code scanning, timing system inspection — we build a complete picture first.",
      ...
      {
        title: "Fast Turnaround & UK-Wide Engine Service From Grays, Essex",
        paragraphs: [
          "Not within reach of our Grays, Essex workshop? We offer a fully managed engine collection and return service covering the entire UK.",
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "Absolutely. We offer a complete supply and fit service at our Grays, Essex workshop. For customers elsewhere in the UK, we can arrange fitting through our approved installer network.",
      },
      {
  ...
  "audi-a5-convertible-engines": {
    metaTitle: "Audi A5 Convertible Engine Rebuild, Repair & Replacement — Expert Service in Grays, Essex",
    metaDescription:
      "Audi A5 Convertible (Cabriolet) engine specialists in Grays, Essex. Repairs, rebuilds, replacements, timing chain/belt and turbo work with UK-wide support and written warranty.",
    h1: "Audi A5 Convertible Engine Rebuild, Repair & Replacement — Expert Service in Grays, Essex",
    intro: [
      ...
      "At Vogue Technics, based in Grays, Essex, we carry out expert engine work on the Audi A5 Convertible across all variants and generations. The 2.0 TFSI, 2.0 TDI, 2.7 TDI, and 3.0 TDI engines fitted to the A5 Cabriolet each have well-documented fault patterns — and we've worked through every single one of them over more than 25 years in the business. Whether you need a full engine rebuild, a targeted repair, a cambelt replacement, or a complete engine swap, we deliver work that holds up long after the car leaves our workshop.",
    ],
    sections: [
      {
        ...
        paragraphs: [
          ...
          "We never recommend work without first understanding the full picture. Every Audi A5 Convertible that comes into our Grays workshop receives a comprehensive diagnostic assessment before we suggest a single pound of expenditure.",
      ...
      },
      {
        title: "Fast UK-Wide Service & Engine Delivery From Grays, Essex",
        paragraphs: [
          "Not within driving distance of our Grays, Essex workshop? We offer a fully managed engine collection and return service covering the entire UK.",
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "Yes. UK-wide collection/delivery is available if you’re not local to Essex.",
      },
      {
        question: "Do you provide written warranty?",
        answer:
  ...
  "audi-a6-engines": {
    metaTitle: "Audi A6 Engine Rebuild, Repair & Replacement — Trusted Specialists in Grays, Essex",
    metaDescription:
      "Audi A6 engine specialists in Grays, Essex. Diagnostics, repairs, rebuilds and replacements for Saloon, Avant and Allroad across generations with UK-wide support and written warranty.",
    h1: "Audi A6 Engine Rebuild, Repair & Replacement — Trusted Specialists in Grays, Essex",
    intro: [
      ...
      "At Vogue Technics, based in Grays, Essex, we've been working on premium European engines for over 25 years. The Audi A6's engine family spans the 2.0 TDI, 3.0 TDI, 2.0 TFSI, 3.0 TFSI, and biturbo configurations across the C6, C7, and C8 generations — and it's a platform we know thoroughly.",
    ],
    sections: [
      {
      ...
      },
      {
        ...
        paragraphs: [
          "Not local to Grays, Essex? We offer UK-wide collection and return, and can support fitting through trusted installers where helpful.",
  ...
  "audi-a6-allroad-engines": {
    metaTitle: "Audi A6 Allroad Engine Rebuild, Repair & Replacement — Specialists in Grays, Essex",
    metaDescription:
      "Audi A6 Allroad engine specialists in Grays, Essex. Repairs, rebuilds and replacements for 3.0 TDI, 2.0 TDI and other variants with UK-wide support and written warranty.",
    h1: "Audi A6 Allroad Engine Rebuild, Repair & Replacement — Specialists in Grays, Essex",
    intro: [
  ...
  "audi-a6-avant-engines": {
    metaTitle: "Audi A6 Avant Engine Rebuild, Repair & Replacement — Expert Service in Grays, Essex",
    metaDescription:
      "Audi A6 Avant engine rebuild, repair and replacement specialists in Grays, Essex. We work across C6/C7/C8 and 2.0 TDI, 3.0 TDI, 2.0 TFSI and 3.0 TFSI variants with thorough diagnostics, honest pricing and written warranty.",
    h1: "Audi A6 Avant Engine Rebuild, Repair & Replacement — Expert Service in Grays, Essex",
    intro: [
    ...
    sections: [
      ...
      {
        title: "Fast UK-Wide Engine Service & Delivery From Grays, Essex",
        paragraphs: [
      ...
      },
      {
        ...
        paragraphs: [
          "Call Vogue Technics today or use our online enquiry form for a fast, no-obligation quote. We're based in Grays, Essex, and serve Audi A6 Avant owners right across the United Kingdom. Precise diagnostics, honest pricing, and engine work built to last — that's 25 years of doing this properly.",
        ],
      },
    ],
    testimonials: [
    ...
    faqs: [
      ...
      },
      {
        question: "Can you supply and fit the engine?",
        answer:
          "Absolutely. We offer a complete supply and fit service at our Grays, Essex workshop. For customers located elsewhere in the UK, we can arrange fitting through our approved installer network.",
      },
      {
      ...
      },
      {
        ...
        answer:
          "Yes. Our engine health check service is available for anyone considering purchasing a used Audi A6 Avant who wants an independent assessment before committing. You'll receive a written report with clear, honest findings. Contact us to arrange an appointment at our Grays workshop.",
      },
      {
  ...
  "audi-a7-sportback-engines": {
    metaTitle: "Audi A7 Sportback Engine Rebuild, Repair & Replacement — Specialists in Grays, Essex",
    metaDescription:
      "Audi A7 Sportback engine rebuild, repair and replacement specialists in Grays, Essex. We cover C7/C8 across 3.0 TDI, 3.0 TFSI, biturbo diesel and RS7 4.0 TFSI with diagnostic-led work, transparent pricing and written warranty.",
    h1: "Audi A7 Sportback Engine Rebuild, Repair & Replacement — Specialists in Grays, Essex",
    intro: [
      ...
      "At Vogue Technics, based in Grays, Essex, we carry out expert engine work on the Audi A7 Sportback across both C7 and C8 generations. The 3.0 TDI, 3.0 TFSI, biturbo diesel, and 4.0 TFSI RS7 units each have their own fault patterns and rebuild requirements — and we've worked through all of them over more than 25 years in the business. Whether your A7 needs a complete engine rebuild, a targeted repair, a timing chain replacement, or a full engine swap, we deliver work that's done properly from start to finish.",
    ],
    sections: [
      {
      ...
      {
        title: "Fast UK-Wide Service & Engine Collection From Grays, Essex",
        paragraphs: [
      ...
      },
      {
        ...
        paragraphs: [
          "Call Vogue Technics today or submit an enquiry through our online form for a fast, no-obligation quote. We're based in Grays, Essex, and serve Audi A7 Sportback owners right across the United Kingdom. Precise diagnostics, honest pricing, and engine work that genuinely lasts — built on 25 years of doing this properly.",
        ],
      },
    ],
    testimonials: [
  ...
  "audi-a8-engines": {
    ...
    sections: [
      ...
      {
        title: "Fast Turnaround & UK-Wide Service From Grays, Essex",
        paragraphs: [
          "We understand that being without your Audi A8 — especially if it's your primary vehicle — is genuinely disruptive. Our workshop in Grays, Essex operates with efficiency and precision to get you back on the road as quickly as possible.",
      ...
      },
      {
        ...
        paragraphs: [
          "Call Vogue Technics today or complete our online enquiry form for a fast, no-obligation quote. We're based in Grays, Essex, and proudly serve Audi A8 owners across the whole of the United Kingdom. Don't trust your A8 to just anyone — trust the specialists.",
        ],
      },
    ],
    testimonials: [
    ...
    faqs: [
      ...
      },
      {
        question: "Can you supply and fit the engine?",
        answer:
          "Yes. We offer full supply and fit at our Grays, Essex workshop, and can also arrange installation through our approved network of fitters across the UK.",
      },
    ],
  },
  "audi-q2-engines": {
    ...
    metaDescription:
      "Audi Q2 engine rebuild, repair and replacement specialists in Grays, Essex. We cover 1.0 TFSI, 1.5 TFSI and 2.0 TDI variants with diagnostic-led work, transparent pricing and written warranty UK-wide.",
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          "We've been rebuilding, repairing, and replacing engines for over a quarter of a century. That experience isn't just a number on a webpage — it's the reason our customers in Grays, across Essex, and throughout the UK keep coming back and recommending us to other Audi owners.",
        ],
      },
      {
      ...
      {
        title: "Fast Turnaround & UK-Wide Service From Our Workshop in Grays, Essex",
        paragraphs: [
          ...
          "Not local to Grays? That's no barrier. We offer a full engine collection and delivery service covering the entire United Kingdom. Send us your unit, and we'll return it rebuilt, tested, and ready to fit — or we can coordinate installation through our trusted network of approved fitters nationwide.",
      ...
      },
      {
        ...
        paragraphs: [
          "Call Vogue Technics today or fill in our online enquiry form for a fast, no-obligation quote. We're based in Grays, Essex, and serve Audi Q2 owners right across the United Kingdom. Don't hand your Q2 to just anyone — trust the specialists who know it properly.",
        ],
      },
    ],
    testimonials: [
    ...
    faqs: [
      ...
      },
      {
        question: "Can you supply and fit the engine?",
        answer:
          "Absolutely. We offer full supply and fit at our Grays, Essex workshop. We can also coordinate fitting through our approved installer network for customers elsewhere in the UK.",
      },
      {
  ...
  "audi-q3-engines": {
    ...
    metaDescription:
      "Audi Q3 engine rebuild, repair and replacement specialists in Grays, Essex. We cover 8U and F3 generations across 1.0/1.4 TFSI and 2.0 TDI variants with accurate diagnosis, transparent pricing and written warranty.",
    ...
    sections: [
      ...
      },
      {
        title: "Written Warranty on Every Engine Job",
        paragraphs: [
          "Every Audi Q3 engine rebuild, replacement, and major repair carried out at our Grays workshop leaves with a written warranty. We stand behind our workmanship without hesitation — because we know the standard to which every job is completed.",
        ],
      },
      {
      ...
      },
      {
        ...
        paragraphs: [
          "Call Vogue Technics today or complete our online enquiry form for a fast, no-obligation quote. We're based in Grays, Essex, and proudly serve Audi Q3 owners right across the United Kingdom. Don't settle for a generalist when your Q3 deserves a specialist — get in touch today.",
        ],
      },
    ],
    testimonials: [
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "Absolutely. We offer full supply and fit at our Grays, Essex workshop. For customers located elsewhere in the UK, we coordinate installation through our trusted network of approved fitters nationwide.",
      },
      {
  ...
  "audi-q5-engines": {
    ...
    metaDescription:
      "Audi Q5 engine rebuild, repair and replacement specialists in Grays, Essex. Expert engine services across 2.0 TDI, 3.0 TDI, 2.0 TFSI and SQ5 3.0 TFSI with diagnostic-led work, transparent pricing and written warranty.",
    ...
    intro: [
      ...
      "At Vogue Technics, based in Grays, Essex, that's precisely what we offer. With over 25 years of hands-on engine expertise and a reputation built entirely on the quality of our work, we're the Audi Q5 engine rebuild specialist that owners across the UK turn to when it matters most.",
    ],
    sections: [
      {
      ...
      {
        title: "Over 25 Years Serving UK Drivers From Grays, Essex",
        paragraphs: [
      ...
      },
      {
        ...
        paragraphs: [
          "Call Vogue Technics today or complete our online enquiry form for a fast, no-obligation quote. We're based in Grays, Essex, and serve Audi Q5 owners across the entire United Kingdom. Trust the specialists — and get it done right.",
        ],
      },
    ],
    testimonials: [
    ...
    faqs: [
      ...
      },
      {
        question: "Can you supply and fit the engine at your workshop?",
        answer:
          "Absolutely. Full supply and fit is available at our Grays, Essex workshop. For customers elsewhere in the UK, we coordinate installation through our approved fitter network.",
      },
      {
  ...
  "audi-q7-engines": {
    ...
    metaDescription:
      "Audi Q7 engine rebuild, repair and replacement specialists in Grays, Essex. Expert diagnostics and warranty-backed work across 3.0 TDI, 4.2 TDI, 3.0 TFSI and V8 petrol variants with UK-wide collection and delivery.",
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Our reputation in Grays and across the wider UK has been earned entirely through the quality and consistency of our work. Not through advertising — through results.",
        ],
      },
      {
      ...
      },
      {
        ...
        paragraphs: [
          "Whether we carry out a targeted Audi Q7 diesel engine repair or a complete engine rebuild, the work leaves our Grays workshop with a written warranty. We stand fully behind our workmanship — because our standards give us every reason to.",
        ],
      },
      {
      ...
      {
        title: "Fast Turnaround & Nationwide Service From Our Grays, Essex Workshop",
        paragraphs: [
      ...
      },
      {
        ...
        paragraphs: [
          "Call Vogue Technics today or complete our online enquiry form for a fast, no-obligation quote. We're based in Grays, Essex, and serve Audi Q7 owners right across the United Kingdom. Get in touch — and get it done properly.",
        ],
      },
    ],
    testimonials: [
    ...
    faqs: [
      ...
      {
        question: "Can you supply and fit the engine at your Grays workshop?",
        answer:
          "Absolutely. Full supply and fit is available at our Grays, Essex workshop. For customers located anywhere else in the UK, we coordinate professional installation through our trusted network of approved fitters nationwide.",
      },
      {
  ...
  "audi-r8-engines": {
    ...
    metaDescription:
      "Audi R8 engine rebuild, repair and replacement specialists in Grays, Essex. High-performance expertise across 4.2 FSI V8 and 5.2 FSI V10 with precision diagnostics, transparent pricing and written warranty UK-wide.",
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          "Every Audi R8 engine rebuild in the UK and every major repair carried out at our Grays workshop leaves with a written warranty. We back our workmanship without reservation — because our standards give us every reason to do so.",
        ],
      },
      {
      ...
      },
      {
        title: "UK-Wide Service & Fast Turnaround From Our Grays, Essex Workshop",
        paragraphs: [
          "Every day your Audi R8 sits off the road is a day it isn't being enjoyed as it was built to be. Our workshop in Grays operates with genuine efficiency and precision — because the car deserves both, and so does your time.",
          "Not located near Grays? That creates no obstacle whatsoever. We operate a full engine collection and return service covering every part of the UK. Send us your unit and we'll return it rebuilt, fully tested, and prepared for installation — or we can coordinate fitting through our network of approved specialist installers nationwide.",
      ...
      },
      {
        ...
        paragraphs: [
          "Call Vogue Technics today or complete our online enquiry form for a fast, no-obligation quote. We're based in Grays, Essex, and serve Audi R8 owners right across the United Kingdom. Trust the specialists — and give your R8 the rebuild it genuinely deserves.",
        ],
      },
    ],
    testimonials: [
    ...
    faqs: [
      ...
      },
      {
        question: "Can you supply and fit the engine at your Grays workshop?",
        answer:
          "Absolutely. Full supply and fit is available at our Grays, Essex workshop. For customers located anywhere else in the UK, we coordinate professional installation through our trusted network of approved performance engine fitters.",
      },
      {
  ...
  "audi-r8-spyder-engines": {
    ...
    metaDescription:
      "Audi R8 Spyder engine rebuild, repair and replacement specialists in Grays, Essex. High-performance expertise across 4.2 FSI V8 and 5.2 FSI V10 with precision diagnostics, transparent pricing and written warranty UK-wide.",
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Our standing in Grays and across the wider UK has been earned entirely through the quality of our work and the honesty of our service. R8 Spyder owners who trust us once invariably return — and send others our way.",
        ],
      },
      {
      ...
      },
      {
        ...
        paragraphs: [
          "Whether we carry out a targeted repair or a complete Audi R8 Spyder engine rebuild, the work leaves our Grays workshop with a written warranty. We stand behind everything we do — because our standards mean we have nothing to qualify or hide.",
        ],
      },
      {
      ...
      {
        title: "Fast Turnaround & UK-Wide Service From Our Grays, Essex Workshop",
        paragraphs: [
      ...
      },
      {
        ...
        paragraphs: [
          "Call Vogue Technics today or complete our online enquiry form for a fast, no-obligation quote. We're based in Grays, Essex, and proudly serve Audi R8 Spyder owners right across the United Kingdom. Don't settle for anything less than genuine specialist expertise — your Spyder has earned it.",
        ],
      },
    ],
    testimonials: [
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "A proper V8 to V10 conversion in the R8 Spyder covers engine removal and replacement, dry-sump system adaptation, mount modification where required, ECU remapping to V10 specifications, ancillary component integration, and comprehensive post-conversion diagnostics and road testing. We handle the complete process at our Grays workshop.",
      },
      {
  ...
  "audi-tt-engines": {
    ...
    metaDescription:
      "Audi TT engine rebuild, repair and replacement specialists in Grays, Essex. We cover 8N/8J/8S generations across 1.8T, 2.0 TFSI and 2.5 TFSI with diagnostic-led work, transparent pricing and written warranty UK-wide.",
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Our reputation in Grays and across the wider UK has been built entirely through results. TT owners who come to us once come back — and recommend us to others without hesitation.",
        ],
      },
      {
      ...
      },
      {
        title: "Written Warranty on Every Engine Job",
        paragraphs: [
          "Every Audi TT engine rebuild in the UK and every major repair completed at our Grays workshop carries a written warranty. We stand behind our workmanship fully — because our standards give us every reason to do so without hesitation.",
        ],
      },
      {
      ...
      },
      {
        title: "Fast Turnaround & UK-Wide Service From Our Grays, Essex Workshop",
        paragraphs: [
          "A TT off the road isn't just an inconvenience — for many owners, it's a genuinely felt absence. Our workshop in Grays operates with real efficiency and genuine care, because we understand what these cars mean to the people who own them.",
          "Not near Grays? That's no issue at all. We operate a full engine collection and return service covering every part of the UK. Send us your unit and we'll return it rebuilt, fully tested, and ready for installation — or we can coordinate fitting through our trusted network of approved performance engine installers nationwide, ensuring professional fitment wherever you're located.",
      ...
      },
      {
        ...
        paragraphs: [
          "Call Vogue Technics today or complete our online enquiry form for a fast, no-obligation quote. We're based in Grays, Essex, and proudly serve Audi TT owners right across the United Kingdom. Trust the specialists — and get your TT back to exactly what it should be.",
        ],
      },
    ],
    testimonials: [
    ...
    faqs: [
      ...
      },
      {
        question: "Can you supply and fit the engine at your Grays workshop?",
        answer:
          "Absolutely. Full supply and fit is available at our Grays, Essex workshop. For customers elsewhere in the UK, we coordinate professional installation through our trusted network of approved fitters nationwide.",
      },
      {
  ...
  "audi-tt-roadster-engines": {
    ...
    metaDescription:
      "Audi TT Roadster engine rebuild, repair and replacement specialists in Grays, Essex. Head gasket, timing chain/belt, turbo and warranty-backed engine services with UK-wide support.",
    h1: "Audi TT Roadster Engines Rebuild — Expert Engine Services Across the UK",
    intro: [
      "If you own an Audi TT Roadster and you're staring down a failing engine, you've found the right people. At Vogue Technics, based in Grays, Essex, we specialise in performance and prestige vehicle engines — and the Audi TT Roadster is a car we know inside out.",
    ...
    sections: [
      ...
      {
        title: "25 Years of Engine Expertise, Right Here in Grays",
        paragraphs: [
      ...
      {
        title: "Fast UK-Wide Service & Local Workshop in Grays, Essex",
        paragraphs: [
      ...
      },
      {
        title: "Engine Collection & Delivery Across the UK",
        paragraphs: [
          "Can't get to Grays? Not a problem. We offer an engine collection and delivery service covering the whole of the UK.",
    ...
    faqs: [
      ...
      },
      {
        question: "Do you cover the whole of the UK?",
        answer:
          "Yes. Our workshop is in Grays, Essex, and we serve TT Roadster owners nationwide via collection/delivery and approved installers.",
      },
    ],
  },
  "audi-a3-convertible-engines": {
    ...
    metaDescription:
      "Audi A3 Convertible (Cabriolet) engine specialists in Grays, Essex. Head gasket, timing chain/belt, turbo, rebuild and replacement services with written warranty and UK-wide support.",
    ...
    intro: [
      ...
      "At Vogue Technics, based in Grays, Essex, we specialise in Audi engine work, and the A3 Convertible — also known as the A3 Cabriolet — is a vehicle we know inside out.",
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          "Since we opened our doors in Grays, we've built our reputation entirely through the quality of our work. Thousands of engines rebuilt, repaired, and replaced.",
      ...
      {
        title: "Fast UK-Wide Service Based in Grays, Essex",
        paragraphs: [
  ...
  "audi-a3-limousine-engines": {
    ...
    metaDescription:
      "Audi A3 Limousine (Saloon) engine specialists in Grays, Essex. Head gasket, timing chain/belt, turbo, rebuild and replacement services with written warranty and UK-wide support.",
    ...
    intro: [
      ...
      "At Vogue Technics, based in Grays, Essex, we specialise in Audi engine work across the full A3 range, and the Limousine variant is a vehicle our technicians know comprehensively — every engine code, every known fault, every correct repair procedure.",
    ...
    sections: [
      ...
      {
        title: "Fast UK-Wide Service From Our Workshop in Grays, Essex",
        paragraphs: [
          "We collect engines from anywhere across the United Kingdom, carry out all work at our Essex facility, and return your unit fully tested, professionally packaged, and ready to install.",
  ...
  "audi-a3-sportback-engines": {
    ...
    metaDescription:
      "Audi A3 Sportback engine specialists in Grays, Essex. Head gasket, timing chain/belt, turbo, rebuild and replacement services with written warranty and UK-wide support.",
    ...
    intro: [
      ...
      "At Vogue Technics, based in Grays, Essex, we specialise in Audi engine work across the complete A3 range, and the Sportback is a body variant we service constantly — across all engine codes, all known fault patterns, and all levels of repair complexity.",
    ...
    sections: [
      ...
      {
        title: "UK-Wide Engine Service Based From Grays, Essex",
        paragraphs: [
          "We collect engines from anywhere in the United Kingdom, carry out all work at our Essex facility, and return your rebuilt or replacement unit fully tested, securely packaged, and ready to install.",
  ...
  "audi-a4-avant-engines": {
    ...
    metaDescription:
      "Audi A4 Avant engine specialists in Grays, Essex. Head gasket, timing chain/belt, turbo, rebuild and replacement services for 2.0 TDI and 2.0 TFSI variants with written warranty and UK-wide support.",
    ...
    intro: [
      ...
      "At Vogue Technics, based in Grays, Essex, we remove that uncertainty entirely. We specialise in Audi engine work across the full A4 range, and the Avant variant — with its 2.0 TDI and 2.0 TFSI engine configurations — is a vehicle we work on consistently throughout the year.",
    ...
    sections: [
      ...
      {
        title: "UK-Wide Engine Service, Based in Grays, Essex",
        paragraphs: [
          "We collect engines from anywhere in the UK, carry out all work at our Essex facility, and return your rebuilt or replacement unit fully tested and professionally packaged.",
  ...
  "audi-a5-sportback-engines": {
    ...
    metaDescription:
      "Audi A5 Sportback engine specialists in Grays, Essex. Head gasket, timing chain/belt, turbo, rebuild and replacement services for 2.0 TDI and 2.0 TFSI variants with written warranty and UK-wide support.",
    ...
    intro: [
      ...
      "At Vogue Technics, based in Grays, Essex, we specialise in Audi engine work across the full A5 range, and the Sportback is a body variant we work on consistently — across the 2.0 TDI and 2.0 TFSI engine families and across the full spectrum of faults these engines are known to develop.",
    ...
    sections: [
      ...
      {
        title: "UK-Wide Engine Service From Grays, Essex",
        paragraphs: [
