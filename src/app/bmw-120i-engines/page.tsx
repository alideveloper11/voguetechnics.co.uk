...
export const metadata: Metadata = {
  title: "BMW 120i Engine Rebuild   Petrol Engine Specialists in , Serving BMW Owners Across the UK",
  description:
    "BMW 120i engine rebuild, repair and replacement in  with UK-wide support. Vogue Technics   petrol engine specialists for N13/B48 platforms with transparent quotes and written warranty.",
...
export default function Bmw120iEnginesPage() {
  return (
    <BmwEngineModelPageClient
      ...
      h1Rest="  Petrol Engine Specialists in , Serving BMW Owners Across the UK"
      heroIntroParagraphs={[
        ...
        "At Vogue Technics, based in , we carry out BMW 120i engine rebuilds, repairs, and replacements with genuine technical depth across all generations   from the N13-engined F20 and F21 models through to the B48-powered LCI and F40 variants. We know these engines. We know what fails on them, why it fails, and exactly what a correct repair involves.",
      ]}
      sections={[
        {
          ...
          paragraphs: [
            ...
            "Over 25 years, our reputation in  and across the UK has grown entirely through word of mouth   because engines that leave our workshop perform as they should and keep performing.",
      ...
      finalCta={{
        ...
        paragraph:
          "Call Vogue Technics today or complete our online enquiry form for a fast, no-obligation quote. We're based in  and serve BMW owners right across the United Kingdom. The 120i deserves more than a guess and a crossed-finger   trust the specialists who know it properly.",
      }}
    />
  );
}
