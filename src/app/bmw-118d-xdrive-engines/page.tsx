...
export const metadata: Metadata = {
  title: "BMW 118d xDrive Engine Rebuild   Four-Wheel-Drive Diesel Specialists in , UK",
  description:
    "BMW 118d xDrive engine rebuild, repair and replacement in  with UK-wide support. Vogue Technics   specialists in xDrive diesel platforms with transparent quotes and written warranty.",
...
export default function Bmw118dXdriveEnginesPage() {
  return (
    <BmwEngineModelPageClient
      ...
      h1Rest="  Four-Wheel-Drive Diesel Specialists in , UK"
      heroIntroParagraphs={[
        "The BMW 118d xDrive is a different proposition to the standard rear-wheel-drive 118d   and that difference matters enormously when the engine needs serious work. The xDrive all-wheel-drive system adds a layer of mechanical complexity that most general garages simply aren't set up to handle properly. At Vogue Technics, based in , we carry out BMW 118d xDrive engine rebuilds, repairs, and replacements with full understanding of how the xDrive drivetrain interacts with the engine and ancillary systems throughout the process.",
      ...
      sections={[
        {
          ...
          paragraphs: [
            ...
            "We don't pad quotes or work up invoices with unnecessary labour lines. Every customer gets a clear, itemised breakdown before any work begins   no vague estimates, no unpleasant surprises when you come to collect. If the diagnosis reveals something unexpected mid-job, we call you first. It's a straightforward way of working, and it's why our customers in  and across the UK come back to us when they need engine work done again.",
          ],
        },
      ]}
      finalCta={{
        ...
        paragraph:
          "Call Vogue Technics today or complete our online enquiry form for a fast, no-obligation quote. We're based in  and serve BMW owners right across the United Kingdom. The xDrive system deserves a specialist who actually understands it   and that's exactly what we are.",
      }}
    />
  );
}
