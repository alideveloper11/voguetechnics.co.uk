...
export default function Gallery() {
  const images = [
    ...
    { src: "/images/gallery/19g.webp", alt: "Vogue Technics Workshop" },
    { src: "/images/gallery/20g.webp", alt: "Engine Remanufacturing Process" },
    { src: "/images/gallery/21g.webp", alt: "Land Rover Specialist Work" },
    { src: "/images/gallery/22g.webp", alt: "Range Rover Repair Bay" },
    { src: "/images/gallery/23g.webp", alt: "Vogue Technics Team" },
  ];
