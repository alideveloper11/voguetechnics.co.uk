...
export const metadata: Metadata = {
  title: "BMW 118d Engine Rebuild — Diesel Engine Specialists Serving Grays & the Whole of the UK",
  description:
    "BMW 118d engine rebuild, repair and replacement in Grays with UK-wide support. Vogue Technics — BMW diesel specialists for N47/B47 engines with transparent quotes and written warranty.",
  ...
  return (
    <BmwEngineModelPageClient
      ...
      finalCta={{
        ...
        paragraph:
          "Call Vogue Technics today or complete our online enquiry form for a fast, no-obligation quote. We're based in Grays and serve BMW owners right across the United Kingdom. Don't settle for guesswork on a diesel this capable — trust the specialists who know it properly.",
      }}
    />
  );
}
