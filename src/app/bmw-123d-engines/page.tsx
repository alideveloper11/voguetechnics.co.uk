...
export const metadata: Metadata = {
  title: "BMW 123d Engine Rebuild — Twin-Turbo Diesel Specialists in Grays, Serving BMW Owners Across the UK",
  description:
    "BMW 123d engine rebuild, repair and replacement in Grays with UK-wide support. Vogue Technics — twin-turbo diesel specialists with transparent quotes and written warranty.",
...
export default function Bmw123dEnginesPage() {
  return (
    <BmwEngineModelPageClient
      ...
      h1Rest="— Twin-Turbo Diesel Specialists in Grays, Serving BMW Owners Across the UK"
      heroIntroParagraphs={[
        ...
        "At Vogue Technics, based in Grays, we carry out BMW 123d engine rebuilds, repairs, and replacements with the specific technical knowledge this engine genuinely demands. We understand the twin-turbo sequential system, the rear-mounted timing chain architecture, the EGR and swirl flap characteristics of the M47 family, and the failure patterns that develop on these engines as mileage climbs. Neither of the main competitors in this space demonstrates any real awareness of what makes the 123d mechanically distinct. We do.",
      ]}
      sections={[
        {
          ...
          paragraphs: [
            ...
            "Our reputation in Grays and across the UK has been built entirely on the results we deliver — because when we fix your 123d, it stays fixed.",
      ...
      finalCta={{
        ...
        paragraph:
          "Call Vogue Technics today or complete our online enquiry form for a fast, no-obligation quote. We're based in Grays and serve BMW owners right across the United Kingdom. The 123d is a genuinely exceptional diesel — it deserves a specialist who genuinely understands it.",
      }}
    />
  );
}
