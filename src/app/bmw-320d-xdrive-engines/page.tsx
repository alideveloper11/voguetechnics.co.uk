...
export const metadata: Metadata = {
  ...
  description:
    "BMW 320d xDrive engine rebuild, repair, replacement and reconditioning across the UK. Vogue Technics in    xDrive diesel specialists with transparent quotes and written warranty.",
  ...
  return (
    <BmwEngineModelPageClient
      ...
      sections={[
        ...
        {
          title: "Nationwide BMW 320d xDrive Engine Service From ",
          paragraphs: [
            "Our workshop is based in , but we serve BMW 320d xDrive owners right across the United Kingdom. We've built our collection and delivery infrastructure specifically so that geography is never a reason to accept a less qualified workshop for a job this technically specific.",
            "Engine Collection & Delivery Across the UK",
            "We offer a fully managed engine collection and delivery service covering the whole of Great Britain. If your 320d xDrive can't reach us in    or if the engine has already failed and the car is off the road   we collect the old unit, carry out the rebuild or replacement at our workshop, and return the finished engine fully tested, correctly packaged, and ready to fit. We can also connect you with approved installation partners nationwide if local fitting is the more practical arrangement for your circumstances.",
      ...
      finalCta={{
        ...
        paragraph:
          "Call Vogue Technics today or complete our online enquiry form for a fast, no-obligation quote. We're based in , and serve BMW 320d xDrive owners right across the United Kingdom. The xDrive system demands a specialist who understands it completely. That's exactly what we are.",
      }}
    />
  );
}
