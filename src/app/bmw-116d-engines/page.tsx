...
export const metadata: Metadata = {
  ...
  description:
    "BMW 116d engine rebuild, repair, replacement and reconditioning across the UK. Vogue Technics in Grays, Essex — specialists in N47/B47/B37 diesel engines with transparent quotes and written warranty.",
